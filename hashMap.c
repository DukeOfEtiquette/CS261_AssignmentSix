...
void removeKey (struct hashMap * ht, KeyType k)
{
	...
	//If we have made it past the first link continue down the chain
	//until we get to a match. Current will always be the link before
	//the link we are checking, so we are able to maintain a proper chain
	//once it is removed
	while(next != 0)
	{
